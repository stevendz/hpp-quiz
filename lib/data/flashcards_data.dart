...
const List<Flashcard> allFlashcards = [
  ...
  Flashcard(
    ...
    terms: [
      Term(
        term: 'ICD-10',
        definition:
            'Internationales Klassifikationssystem der WHO für Krankheiten, 10. Revision',
      ),
      Term(
        term: 'Kapitel V',
        definition:
            'Abschnitt F00-F99 der ICD-10 für psychische und Verhaltensstörungen',
      ),
      Term(
        term: 'Phänomenologisch-deskriptiv',
        definition: 'Beschreibend nach Symptomen, nicht nach Ursachen',
      ),
    ],
  ),
  Flashcard(
    ...
    terms: [
      Term(
        term: 'Multiaxiales System',
        definition:
            'Ermöglicht mehrdimensionale Diagnostik auf verschiedenen Achsen',
      ),
    ],
  ),
  Flashcard(
  ...
  Flashcard(
    ...
    terms: [
      Term(
        term: 'Intelligenzminderung',
        definition:
            'deutlich unterdurchschnittliche Intelligenz (IQ <70) mit Einschränkung der Anpassungsfähigkeit',
      ),
    ],
  ),
  Flashcard(
  ...
  Flashcard(
    ...
    terms: [
      Term(
        term: 'Somatische Abklärung',
        definition:
            'Ausschluss körperlicher Ursachen vor psychischer Diagnose – HPP-Kernkompetenz',
      ),
    ],
  ),
  Flashcard(
    ...
    terms: [
      Term(
        term: 'Alzheimer-Demenz (F00)',
        definition:
            'Häufigste Demenzform mit schleichendem Beginn und progredientem Verlauf',
      ),
      Term(
        term: 'Amyloid-Plaques',
        definition:
            'Pathologische Eiweißablagerungen im Gehirn, typisch für Alzheimer',
      ),
    ],
  ),
  Flashcard(
    ...
    terms: [
      Term(
        term: 'Vaskuläre Demenz (F01)',
        definition:
            'Demenz durch Durchblutungsstörungen im Gehirn, plötzlicher/stufenweiser Beginn',
      ),
    ],
  ),
  Flashcard(
    ...
    terms: [
      Term(
        term: 'Pick-Krankheit',
        definition:
            'Frontotemporale Demenz mit Persönlichkeitsveränderung und Enthemmung',
      ),
      Term(
        term: 'Creutzfeldt-Jakob',
        definition: 'Prionenerkrankung mit rapid progredientem Verlauf',
      ),
    ],
  ),
  Flashcard(
    ...
    terms: [
      Term(
        term: 'Korsakow-Syndrom',
        definition:
            'Amnestisches Syndrom mit Konfabulationen, häufig bei chronischem Alkoholismus',
      ),
      Term(
        term: 'Konfabulationen',
        definition:
            'Unbewusstes Füllen von Erinnerungslücken mit erfundenen Inhalten',
      ),
    ],
  ),
  Flashcard(
    ...
    terms: [
      Term(
        term: 'Delir (F05)',
        definition:
            'Akuter Verwirrtheitszustand mit Bewusstseinsstörung – immer ein Notfall',
      ),
      Term(
        term: 'Delirium tremens',
        definition:
            'Alkoholentzugsdelir mit Tremor, optischen Halluzinationen und vegetativen Störungen',
      ),
    ],
  ),
  Flashcard(
  ...
  Flashcard(
    ...
    terms: [
      Term(
        term: 'Enzephalitis',
        definition:
            'Entzündung des Gehirns – kann Bewusstseinsstörungen, Wesensänderung und Krampfanfälle verursachen',
      ),
      Term(
        term: 'Schädel-Hirn-Trauma',
        definition:
            'Hirnverletzung durch äußere Gewalt – mögliche Folgen: organisches Psychosyndrom, Wesensänderung, Demenz',
      ),
    ],
  ),
  Flashcard(
    ...
    terms: [
      Term(
        term: 'Pseudodemenz',
        definition:
            'Depression im Alter mit demenziellen Symptomen – Patient klagt aktiv über Vergesslichkeit',
      ),
    ],
  ),
  Flashcard(
    ...
    terms: [
      Term(
        term: 'Vigilanz',
        definition:
            'Wachheit/Wachsamkeit – bei quantitativen Bewusstseinsstörungen gestört',
      ),
      Term(
        term: 'Somnolenz',
        definition: 'Abnorme Schläfrigkeit, durch Ansprechen weckbar',
      ),
      Term(
        term: 'Sopor',
        definition: 'Tiefe Bewusstlosigkeit, nur durch starke Reize weckbar',
      ),
    ],
  ),
  Flashcard(
    ...
    terms: [
      Term(
        term: 'MMST',
        definition:
            'Mini-Mental-Status-Test – Standardinstrument zum Demenz-Screening (max. 30 Punkte)',
      ),
    ],
  ),
  Flashcard(
    ...
    terms: [
      Term(
        term: 'Apathie',
        definition: 'Teilnahmslosigkeit, Mangel an Antrieb und Interesse',
      ),
    ],
  ),
  ...
  Flashcard(
    ...
    terms: [
      Term(
        term: 'Akute Intoxikation (.0)',
        definition: 'Akuter Rauschzustand, dosisabhängig',
      ),
      Term(
        term: 'Schädlicher Gebrauch (.1)',
        definition:
            'Nachweisbare Schädigung durch Substanzkonsum, ohne Abhängigkeit',
      ),
      Term(
        term: 'Abhängigkeitssyndrom (.2)',
        definition: 'Mind. 3 von 6 Kriterien über 1 Monat',
      ),
    ],
  ),
  Flashcard(
    ...
    terms: [
      Term(
        term: 'Craving',
        definition: 'Starkes, zwanghaftes Verlangen nach einer Substanz',
      ),
      Term(
        term: 'Toleranzentwicklung',
        definition: 'Dosissteigerung nötig, um gleiche Wirkung zu erzielen',
      ),
      Term(
        term: 'Kontrollverlust',
        definition:
            'Unfähigkeit, Menge oder Dauer des Konsums zu kontrollieren',
      ),
    ],
  ),
  Flashcard(
  ...
  Flashcard(
    ...
    terms: [
      Term(
        term: 'Tremor',
        definition:
            'Unwillkürliches rhythmisches Zittern – Kardinalsymptom des Alkoholentzugs',
      ),
    ],
  ),
  Flashcard(
    ...
    terms: [
      Term(
        term: 'Alkoholhalluzinose',
        definition:
            'Akustische Halluzinationen bei KLAREM Bewusstsein – Abgrenzung zum Delir',
      ),
    ],
  ),
  Flashcard(
    ...
    terms: [
      Term(
        term: 'Wernicke-Enzephalopathie',
        definition:
            'Akute Hirnschädigung durch Vitamin-B1-Mangel bei Alkoholismus',
      ),
    ],
  ),
  Flashcard(
    ...
    terms: [
      Term(
        term: 'Delirium tremens',
        definition:
            'schweres Alkoholentzugsdelir mit Bewusstseinsstörung und vegetativer Entgleisung',
      ),
      Term(
        term: 'Tachykardie',
        definition: 'beschleunigter Herzschlag (>100/min)',
      ),
    ],
  ),
  Flashcard(
    ...
    terms: [
      Term(
        term: 'Mydriasis',
        definition:
            'Pupillenerweiterung – typisch bei Cannabis, Stimulanzien, Halluzinogenen',
      ),
      Term(
        term: 'Amotivationales Syndrom',
        definition:
            'Antriebsminderung und Leistungsabfall bei chronischem Cannabiskonsum',
      ),
    ],
  ),
  Flashcard(
    ...
    terms: [
      Term(
        term: 'Miosis',
        definition:
            'Pupillenverengung ("Stecknadelpupillen") – Leitsymptom bei Opioidintoxikation',
      ),
    ],
  ),
  Flashcard(
    ...
    terms: [
      Term(
        term: 'Benzodiazepine',
        definition:
            'Sedativa mit Abhängigkeitspotenzial und Kumulationsgefahr – nie abrupt absetzen',
      ),
    ],
  ),
  Flashcard(
    ...
    terms: [
      Term(
        term: 'Remission',
        definition:
            'Deutliches Nachlassen oder vollständiges Verschwinden der Symptomatik',
      ),
    ],
  ),
  Flashcard(
  ...
  Flashcard(
    ...
    terms: [
      Term(
        term: 'Akustische Halluzinationen',
        definition:
            'Stimmenhören ohne reale Quelle – häufigste Halluzinationsform bei Schizophrenie',
      ),
      Term(
        term: 'Stupor',
        definition: 'Zustand motorischer Erstarrung bei wachem Bewusstsein',
      ),
    ],
  ),
  Flashcard(
    ...
    terms: [
      Term(
        term: 'Naloxon',
        definition: 'Opioid-Antagonist als Gegenmittel bei Opioidintoxikation',
      ),
    ],
  ),
  Flashcard(
  ...
  Flashcard(
    ...
    terms: [
      Term(
        term: 'Erstrangsymptome',
        definition:
            'Pathognomonische Symptome nach Schneider – beweisend für Schizophrenie',
      ),
      Term(
        term: 'Gedankenlautwerden',
        definition: 'Patient hört seine eigenen Gedanken laut ausgesprochen',
      ),
      Term(
        term: 'Gedankenausbreitung',
        definition:
            'Überzeugung, dass andere die eigenen Gedanken lesen können',
      ),
    ],
  ),
  Flashcard(
    ...
    terms: [
      ...
      Term(
        term: 'Ratlosigkeit',
        definition:
            'Unfähigkeit, sich in der Situation zurechtzufinden – Störung der Affektivität (AMDP)',
      ),
    ],
  ),
  Flashcard(
    ...
    terms: [
      Term(
        term: 'Positivsymptome',
        definition:
            'Symptomüberschuss: Wahn, Halluzinationen, Ich-Störungen, Denkstörungen',
      ),
    ],
  ),
  Flashcard(
    ...
    terms: [
      Term(
        term: 'Negativsymptome',
        definition:
            'Symptomdefizit: die "6 A" – Affektverflachung, Apathie, Alogie, Anhedonie, Aufmerksamkeit↓, Asozialität',
      ),
      Term(
        term: 'Alogie',
        definition: 'Sprachverarmung – reduzierter Sprachfluss und -inhalt',
      ),
  ...
  Flashcard(
    ...
    terms: [
      Term(
        term: 'Paranoide Schizophrenie (F20.0)',
        definition:
            'Häufigste Schizophrenie-Form mit Wahn + Halluzinationen im Vordergrund',
      ),
    ],
  ),
  Flashcard(
    ...
    terms: [
      Term(
        term: 'Hebephrene Schizophrenie (F20.1)',
        definition:
            'Läppischer Affekt und Antriebsstörung, typisch bei Jugendlichen',
      ),
    ],
  ),
  Flashcard(
    ...
    terms: [
      Term(
        term: 'Flexibilitas cerea',
        definition:
            'Wächserne Biegsamkeit – passive Bewegungen werden beibehalten',
      ),
      Term(
        term: 'Stupor',
        definition: 'Psychomotorische Erstarrung bei wachem Bewusstsein',
      ),
      Term(
        term: 'Negativismus',
        definition:
            'Widerstand gegen Aufforderungen oder Gegenteil des Aufgeforderten tun',
      ),
      Term(
        term: 'Mutismus',
        definition: 'Schweigen/Verstummen bei erhaltener Sprachfähigkeit',
      ),
      Term(
        term: 'Befehlsautomatie',
        definition:
            'Automatisches Befolgen aller Aufforderungen – katatones Symptom',
      ),
    ],
  ),
  Flashcard(
    ...
    terms: [
      Term(
        term: 'Affektverflachung',
        definition:
            'verminderter emotionaler Ausdruck und eingeschränkte Bandbreite des Gefühlslebens (Negativsymptom)',
      ),
      Term(
        term: 'Positivsymptome',
        definition:
            'produktive Symptome, die über das Normale hinausgehen (Wahn, Halluzinationen)',
      ),
    ],
  ),
  Flashcard(
    ...
    terms: [
      Term(
        term: 'Negativsymptome',
        definition:
            'Einschränkungen des normalen Erlebens (Apathie, Affektverflachung, Anhedonie)',
      ),
      Term(
        term: 'Positivsymptome',
        definition:
  ...
  Flashcard(
    ...
    terms: [
      Term(
        term: 'Schizoaffektive Störung (F25)',
        definition:
            'Gleichzeitig schizophrene UND affektive Symptome in gleicher Episode',
      ),
    ],
  ),
  Flashcard(
    ...
    terms: [
      Term(
        term: 'Prodromalphase',
        definition:
            'Vorstadium mit unspezifischen Symptomen vor Ausbruch der Psychose',
      ),
    ],
  ),
  Flashcard(
  ...
  Flashcard(
    ...
    terms: [
      Term(
        ...
        definition:
            'Entfremdung vom eigenen Ich – fühlt sich losgelöst vom eigenen Körper',
      ),
      Term(
        term: 'Derealisation',
        definition: 'Umwelt wird als unwirklich/fremd wahrgenommen',
      ),
    ],
  ),
  Flashcard(
    ...
    terms: [
      Term(
        term: 'Ideenflucht',
        definition:
            'Übermäßig schnelle Abfolge von Einfällen mit erkennbarem Zusammenhang – typisch bei Manie',
      ),
      Term(
        term: 'Zerfahrenheit',
        definition:
            'Zusammenhangloses, unverständliches Denken – typisch bei Schizophrenie',
      ),
      Term(
        term: 'Perseveration',
        definition: 'Haftenbleiben an Denkinhalten oder Wörtern',
      ),
      Term(
        term: 'Konkretismus',
        definition:
            'Unfähigkeit, abstrakt zu denken – Sprichwörter werden wörtlich genommen',
      ),
    ],
  ),
  Flashcard(
    ...
    terms: [
      Term(
        term: 'Ich-synton',
        definition:
            'Symptome werden als zum Selbst gehörig empfunden (z.B. Wahn, PS)',
      ),
      Term(
        term: 'Ich-dyston',
        definition:
            'Symptome werden als fremd/quälend erlebt (z.B. Zwangsgedanken)',
      ),
    ],
  ),
  Flashcard(
    ...
    terms: [
      ...
      Term(
        term: 'Ich-Störungen',
        definition:
            'Störungen der Ich-Grenze: Depersonalisation, Derealisation, Gedankeneingebung, -entzug, -ausbreitung',
      ),
    ],
  ),
  Flashcard(
    ...
    terms: [
      Term(
        term: 'Folie à deux',
        definition:
            'Induzierte wahnhafte Störung – Wahn wird von einer Person auf eine andere übertragen',
      ),
    ],
  ),
  ...
  Flashcard(
    ...
    terms: [
      Term(
        term: 'Manische Episode (F30)',
        definition:
            'Gehobene Stimmung, Antriebssteigerung, Größenideen, Rededrang – mind. 1 Woche',
      ),
    ],
  ),
  Flashcard(
    ...
    terms: [
      Term(
        term: 'Bipolare Störung (F31)',
        definition: 'Wechsel zwischen manischen und depressiven Episoden',
      ),
      Term(
        term: 'Gemischte Episode',
        definition: 'Gleichzeitig manische und depressive Symptome (F31.6)',
      ),
    ],
  ),
  Flashcard(
  ...
  Flashcard(
    ...
    terms: [
      Term(
        term: 'Verarmungswahn',
        definition: 'wahnhafte Überzeugung, finanziell ruiniert zu sein',
      ),
    ],
  ),
  Flashcard(
  ...
  Flashcard(
    ...
    terms: [
      Term(
        term: 'Zyklothymia (F34.0)',
        definition:
            'Chronische leichte Stimmungsschwankungen ≥2 Jahre, nicht bipolar',
      ),
      Term(
        term: 'Dysthymia (F34.1)',
        definition: 'Chronische leichte depressive Verstimmung ≥2 Jahre',
      ),
    ],
  ),
  Flashcard(
    ...
    terms: [
      Term(
        term: 'Rezidiv',
        definition:
            'Wiederauftreten einer Erkrankung nach symptomfreiem Intervall',
      ),
    ],
  ),
  Flashcard(
    ...
    terms: [
      Term(
        term: 'Somatisches Syndrom',
        definition:
            'Körperliche Begleiterscheinungen der Depression: Früherwachen, Morgentief, Appetit↓, Libido↓',
      ),
    ],
  ),
  Flashcard(
    ...
    terms: [
      Term(
        term: 'Antidepressiva',
        definition:
            'Medikamente zur Behandlung von Depressionen (SSRI, SNRI, TZA, MAO-Hemmer)',
      ),
    ],
  ),
  Flashcard(
    ...
    terms: [
      Term(
        term: 'Pöldinger-Stufen',
        definition:
            'Erwägung → Ambivalenz → Entschluss – Modell der suizidalen Entwicklung',
      ),
    ],
  ),
  Flashcard(
  ...
  Flashcard(
    ...
    terms: [
      Term(
        term: 'Lithium',
        definition:
            'Phasenprophylaktikum bei bipolarer Störung – enge therapeutische Breite',
      ),
      Term(
        term: 'Hypomanie',
        definition:
            'Leichtere Form der Manie ohne Psychose und ohne schwere Funktionsbeeinträchtigung',
      ),
    ],
  ),
  Flashcard(
    ...
    terms: [
      Term(
        term: 'Lichttherapie',
        definition:
            'Behandlung mit hellem Licht, besonders wirksam bei saisonaler Depression',
      ),
      Term(
        term: 'Zyklothymia (F34.0)',
        definition:
            'Chronische leichte Stimmungsschwankungen über ≥2 Jahre – nicht bipolar',
      ),
    ],
  ),
  Flashcard(
    ...
    terms: [
      Term(
        term: 'Hypothyreose',
        definition:
            'Schilddrüsenunterfunktion – kann Depression imitieren: Antriebsmangel, Müdigkeit, Bradykardie',
      ),
    ],
  ),
  ...
  Flashcard(
    ...
    terms: [
      Term(
        term: 'Agoraphobie (F40.0)',
        definition:
            'Angst vor Menschenmengen, öffentlichen Plätzen und Situationen ohne Fluchtmöglichkeit',
      ),
    ],
  ),
  Flashcard(
    ...
    terms: [
      Term(
        term: 'Soziale Phobie (F40.1)',
        definition:
            'Angst vor Bewertung in sozialen Situationen – Erröten, Zittern, Vermeidung',
      ),
    ],
  ),
  Flashcard(
    ...
    terms: [
      Term(
        term: 'Systematische Desensibilisierung',
        definition:
            'schrittweise Konfrontation mit Angstreizen bei gleichzeitiger Entspannung (Wolpe)',
      ),
      Term(
        term: 'Flooding',
        definition:
            'Reizüberflutung: sofortige, massive Konfrontation mit dem angstauslösenden Reiz',
      ),
    ],
  ),
  Flashcard(
    ...
    terms: [
      Term(
        term: 'Panikstörung (F41.0)',
        definition:
            'Wiederkehrende unerwartete Panikattacken mit vegetativen Symptomen',
      ),
      Term(
        term: 'Erwartungsangst',
        definition:
            'Angst vor der nächsten Panikattacke ("Angst vor der Angst")',
      ),
    ],
  ),
  Flashcard(
    ...
    terms: [
      Term(
        term: 'GAD (F41.1)',
        definition: 'Anhaltende frei flottierende Angst und Sorgen ≥6 Monate',
      ),
    ],
  ),
  Flashcard(
    ...
    terms: [
      Term(
        term: 'Zwangsstörung (F42)',
        definition:
            'Wiederkehrende Zwangsgedanken/-handlungen, ich-dyston, als sinnlos erkannt',
      ),
    ],
  ),
  Flashcard(
  ...
  Flashcard(
    ...
    terms: [
      Term(
        term: 'PTBS (F43.1)',
        definition:
            'Verzögerte Reaktion auf schweres Trauma: Intrusionen + Vermeidung + Hyperarousal',
      ),
      Term(
        term: 'Intrusionen',
        definition:
            'Ungewolltes Wiedererleben traumatischer Erlebnisse (Flashbacks, Albträume)',
      ),
      Term(
        term: 'Hyperarousal',
        definition:
            'Übererregungszustand: Schreckhaftigkeit, Schlafstörungen, Reizbarkeit',
      ),
    ],
  ),
  Flashcard(
    ...
    terms: [
      Term(
        term: 'Flashbacks',
        definition:
            'plötzliches Wiedererleben traumatischer Szenen, als geschähen sie gerade',
      ),
    ],
  ),
  Flashcard(
    ...
    terms: [
      Term(
        term: 'Dissoziative Fugue',
        definition:
            'Plötzliches Wegreisen mit Amnesie bei äußerlich geordnetem Verhalten',
      ),
      Term(
        term: 'Konversionsstörung',
        definition:
            'Neurologisch anmutende Symptome (Lähmung, Krampfanfälle) ohne organischen Befund',
      ),
    ],
  ),
  Flashcard(
    ...
    terms: [
      Term(
        term: 'Somatisierungsstörung (F45.0)',
        definition:
            'Multiple wechselnde körperliche Beschwerden ohne organischen Befund ≥2 Jahre',
      ),
      Term(
        term: 'Hypochondrie (F45.2)',
        definition:
            'Anhaltende Überzeugung, an einer schweren Krankheit zu leiden',
      ),
    ],
  ),
  Flashcard(
  ...
  Flashcard(
    ...
    terms: [
      Term(
        term: 'Dissoziative Amnesie',
        definition:
            'psychogen bedingter Gedächtnisverlust für belastende Ereignisse',
      ),
    ],
  ),
  Flashcard(
  ...
  Flashcard(
    ...
    terms: [
      Term(
        term: 'Primärer Krankheitsgewinn',
        definition:
            'Innerpsychischer Gewinn durch Symptombildung (z.B. Angstreduktion)',
      ),
      Term(
        term: 'Sekundärer Krankheitsgewinn',
        definition:
            'Äußere Vorteile aus der Krankenrolle (Zuwendung, Entlastung) – oft unbewusst',
      ),
    ],
  ),
  Flashcard(
    ...
    terms: [
      Term(
        term: 'Da-Costa-Syndrom',
        definition:
            'Herzneurose – somatoforme autonome Funktionsstörung des Herzens (F45.30)',
      ),
    ],
  ),
  ...
  Flashcard(
    ...
    terms: [
      Term(
        term: 'Anorexia nervosa (F50.0)',
        definition:
            'Magersucht: BMI ≤17,5, Körperschemastörung, Amenorrhö – höchste Mortalitätsrate',
      ),
      Term(
        term: 'Refeeding-Syndrom',
        definition:
            'Lebensgefährliche Komplikation bei zu schneller Wiederernährung nach Hungern',
      ),
    ],
  ),
  Flashcard(
    ...
    terms: [
      Term(
        term: 'Bulimia nervosa (F50.2)',
        definition:
            'Essanfälle + kompensatorisches Verhalten (Erbrechen), bei oft normalem Gewicht',
      ),
    ],
  ),
  Flashcard(
    ...
    terms: [
      Term(
        ...
        definition:
            'Essanfälle OHNE Kompensation – häufig mit Übergewicht und Schuldgefühlen',
      ),
    ],
  ),
  Flashcard(
    ...
    terms: [
      Term(
        term: 'Hypersomnie',
        definition:
            'übermäßige Tagesschläfrigkeit oder verlängerte Schlafdauer',
      ),
    ],
  ),
  Flashcard(
    ...
    terms: [
      Term(
        term: 'Paraphilien (F65)',
        definition:
            'Störungen der Sexualpräferenz: Fetischismus, Sadismus, Pädophilie u.a.',
      ),
    ],
  ),
  Flashcard(
    ...
    terms: [
      Term(
        term: 'Kataplexie',
        definition:
            'Plötzlicher Verlust des Muskeltonus bei Emotionen – typisch für Narkolepsie',
      ),
    ],
  ),
  Flashcard(
  ...
  Flashcard(
    ...
    terms: [
      Term(
        term: 'Körperdysmorphe Störung',
        definition: 'überwertige Überzeugung, entstellt oder hässlich zu sein',
      ),
      Term(
        term: 'Hyperthyreose',
        definition:
            'Schilddrüsenüberfunktion – Unruhe, Tachykardie, Gewichtsverlust; DD zu Angststörung und Manie',
      ),
    ],
  ),
  Flashcard(
    ...
    terms: [
      Term(
        term: 'FASD',
        definition:
            'Fetales Alkoholsyndrom – vorgeburtliche Schädigung durch Alkohol mit typischen Gesichtsmerkmalen',
      ),
    ],
  ),
  ...
  Flashcard(
    ...
    terms: [
      Term(
        term: 'Adoleszenz',
        definition:
            'Entwicklungsphase zwischen Kindheit und Erwachsenenalter (etwa 12. bis 21. Lebensjahr)',
      ),
      Term(
        term: 'Kognition',
        definition:
            'Sammelbegriff für Denkprozesse: Wahrnehmen, Erinnern, Urteilen, Problemlösen',
      ),
    ],
  ),
  Flashcard(
    ...
    terms: [
      Term(
        term: 'Paranoide PS (F60.0)',
        definition:
            'Übermäßiges Misstrauen, Empfindlichkeit, Streitsucht – Cluster A',
      ),
    ],
  ),
  Flashcard(
    ...
    terms: [
      Term(
        term: 'Schizoide PS (F60.1)',
        definition:
            'Emotionale Kühle, Einzelgänger, wenig Interesse an Kontakten – Cluster A',
      ),
    ],
  ),
  Flashcard(
    ...
    terms: [
      Term(
        term: 'Dissoziale PS (F60.2)',
        definition:
            'Missachtung sozialer Normen, fehlende Empathie, Aggressivität – Cluster B',
      ),
    ],
  ),
  Flashcard(
    ...
    terms: [
      Term(
        term: 'Borderline-PS (F60.31)',
        definition:
            'Gestörtes Selbstbild, chronische Leere, instabile Beziehungen, Selbstschädigung',
      ),
    ],
  ),
  Flashcard(
    ...
    terms: [
      Term(
        term: 'Histrionische PS (F60.4)',
        definition:
            'Dramatisierung, Theatralik, Aufmerksamkeitssuche – Cluster B',
      ),
    ],
  ),
  Flashcard(
    ...
    terms: [
      Term(
        term: 'Anankastische PS (F60.5)',
        definition:
            'Perfektionismus, Rigidität, übermäßige Gewissenhaftigkeit – ich-synton, Cluster C',
      ),
    ],
  ),
  Flashcard(
    ...
    terms: [
      Term(
        term: 'Ängstliche PS (F60.6)',
        definition:
            'Vermeidung aus Angst vor Ablehnung, wünscht sich aber Kontakte – Cluster C',
      ),
    ],
  ),
  Flashcard(
    ...
    terms: [
      Term(
        term: 'Abhängige PS (F60.7)',
        definition:
            'Verlassensangst, Entscheidungsunfähigkeit, Unterordnung – Cluster C',
      ),
    ],
  ),
  Flashcard(
  ...
  Flashcard(
    ...
    terms: [
      Term(
        term: 'Zwangsstörung (F42)',
        definition:
            'wiederkehrende Zwangsgedanken und/oder -handlungen, ich-dyston',
      ),
    ],
  ),
  Flashcard(
  ...
  Flashcard(
    ...
    terms: [
      Term(
        term: 'Komorbidität',
        definition:
            'gleichzeitiges Vorliegen mehrerer Erkrankungen bei einer Person',
      ),
    ],
  ),
  Flashcard(
    ...
    terms: [
      Term(
        term: 'Legasthenie',
        definition:
            'Lese-Rechtschreibstörung bei normalem IQ – gezielt behandelbar',
      ),
    ],
  ),
  Flashcard(
    ...
    terms: [
      Term(
        term: 'Frühkindlicher Autismus (F84.0)',
        definition:
            'Kanner-Syndrom: Soziale Interaktion↓, Kommunikation↓, Stereotypien – vor 3. LJ',
      ),
    ],
  ),
  Flashcard(
    ...
    terms: [
      Term(
        term: 'Asperger-Syndrom (F84.5)',
        definition:
            'Autismus-Spektrum OHNE Sprach-/Kognitionsverzögerung, mit Spezialinteressen',
      ),
    ],
  ),
  Flashcard(
    ...
    terms: [
      Term(
        term: 'ADHS (F90)',
        definition:
            'Aufmerksamkeitsdefizit + Hyperaktivität + Impulsivität – Beginn vor 7. LJ, ≥6 Monate',
      ),
    ],
  ),
  Flashcard(
    ...
    terms: [
      Term(
        term: 'Methylphenidat',
        definition:
            'Stimulanz zur ADHS-Behandlung – Therapie der Wahl, KEIN Beruhigungsmittel',
      ),
    ],
  ),
  Flashcard(
  ...
  Flashcard(
    ...
    terms: [
      Term(
        term: 'Elektiver Mutismus',
        definition:
            'Kind spricht nur in bestimmten Situationen (z.B. zu Hause ja, in Schule nein)',
      ),
    ],
  ),
  Flashcard(
    ...
    terms: [
      Term(
        term: 'Tourette-Syndrom (F95.2)',
        definition:
            'Multiple motorische + vokale Tics ≥12 Monate – Koprolalie möglich',
      ),
      Term(
        term: 'Echolalie',
        definition: 'Zwanghaftes Nachsprechen von gehörten Wörtern/Sätzen',
      ),
    ],
  ),
  Flashcard(
    ...
    terms: [
      Term(
        term: 'Enuresis',
        definition:
            'Einnässen – vor 5. LJ normal, danach diagnostisch relevant',
      ),
      Term(
        term: 'Enkopresis',
        definition: 'Unwillkürliches oder willkürliches Einkoten ab dem 4. LJ',
      ),
    ],
  ),
  Flashcard(
    ...
    terms: [
      Term(
        term: 'Rigor',
        definition: 'Muskelsteifheit – Kardinalsymptom bei Parkinson',
      ),
      Term(
        term: 'Akinese',
        definition:
            'Bewegungsarmut bis Bewegungslosigkeit – Kardinalsymptom bei Parkinson',
      ),
      Term(
        term: 'Mikrografie',
        definition: 'Verkleinertes Schriftbild – typisch bei Parkinson',
      ),
    ],
  ),
  ...
  Flashcard(
    ...
    terms: [
      Term(
        term: 'Pseudodemenz',
        definition:
            'depressionsbedingte kognitive Störungen, die eine Demenz vortäuschen',
      ),
      Term(
        term: 'Konfabulationen',
        definition:
            'Erinnerungslücken werden unbewusst mit erfundenen Inhalten gefüllt',
      ),
    ],
  ),
  Flashcard(
    ...
    terms: [
      Term(
        term: 'Dysthymia (F34.1)',
        definition:
            'Chronisch leichte depressive Verstimmung über ≥2 Jahre – erfüllt nicht die Kriterien einer depressiven Episode',
      ),
    ],
  ),
  Flashcard(
    ...
    terms: [
      Term(
        term: 'Ich-dyston',
        definition: 'als fremd und störend erlebt, Patient leidet darunter',
      ),
    ],
  ),
  Flashcard(
    ...
    terms: [
      Term(
        term: 'Hypoglykämie',
        definition:
            'Unterzuckerung – Unruhe, Schwitzen, Verwirrtheit; DD zu Angst- und Erregungszuständen',
      ),
      Term(
        term: 'Hypothyreose',
        definition:
  ...
  Flashcard(
    ...
    terms: [
      Term(
        term: 'Halluzination',
        definition:
            'Wahrnehmung OHNE realen Reiz – akustisch, optisch, taktil, olfaktorisch, gustatorisch',
      ),
      Term(
        term: 'Illusionäre Verkennung',
        definition:
            'Fehldeutung eines real vorhandenen Reizes – kann auch bei Gesunden auftreten',
      ),
    ],
  ),
  Flashcard(
  ...
  Flashcard(
    ...
    terms: [
      Term(
        term: 'Tachykardie',
        definition:
            'Beschleunigter Herzschlag (>100/min) – z.B. bei Hyperthyreose, Panikattacke, Entzug',
      ),
      Term(
        term: 'Bradykardie',
        definition:
            'Verlangsamter Herzschlag (<60/min) – z.B. bei Hypothyreose',
      ),
    ],
  ),
  Flashcard(
    ...
    terms: [
      Term(
        term: 'Absencen',
        definition:
            'Kurze Bewusstseinsaussetzer bei Epilepsie – vor allem bei Kindern',
      ),
    ],
  ),
  Flashcard(
  ...
  Flashcard(
    ...
    terms: [
      Term(
        term: 'Parathymie',
        definition:
            'Inadäquater Affekt – z.B. Lachen bei traurigem Inhalt (typisch bei Schizophrenie)',
      ),
      Term(
        term: 'Affektverflachung',
        definition:
            'Reduzierte emotionale Schwingungsfähigkeit – Negativsymptom der Schizophrenie',
      ),
      Term(
        term: 'Ambivalenz',
        definition:
            'Gleichzeitiges Bestehen widersprüchlicher Gefühle oder Wünsche',
      ),
    ],
  ),
  ...
  Flashcard(
    ...
    terms: [
      Term(
        term: 'Kognitive Umstrukturierung',
        definition:
            'Veränderung dysfunktionaler Denkmuster durch Hinterfragen und Neubewertung',
      ),
      Term(
        term: 'Reattribuierung',
        definition:
            'Neue Zuschreibung einseitiger Bewertungen – Technik der kognitiven Umstrukturierung',
      ),
    ],
  ),
  Flashcard(
    ...
    terms: [
      Term(
        term: 'Flooding',
        definition:
            'Reizüberflutung – direkte Konfrontation mit dem angstauslösenden Reiz',
      ),
      Term(
        term: 'Habituation',
        definition:
            'Gewöhnung – Angstreaktion nimmt bei wiederholter Exposition ab',
      ),
      Term(
        term: 'Systematische Desensibilisierung',
        definition:
            'Stufenweise Annäherung an den Angstreiz in Kombination mit Entspannung',
      ),
    ],
  ),
  Flashcard(
    ...
    terms: [
      Term(
        term: 'Freies Assoziieren',
        definition:
            'Grundregel der Psychoanalyse – alles aussprechen, was einfällt',
      ),
      Term(
        term: 'Übertragung',
        definition:
            'Unbewusstes Übertragen früherer Beziehungsmuster auf den Therapeuten',
      ),
      Term(
        term: 'Widerstand',
        definition:
            'Unbewusste Abwehr gegen das Bewusstwerden verdrängter Inhalte',
      ),
    ],
  ),
  Flashcard(
    ...
    terms: [
      Term(
        term: 'Empathie',
        definition: 'Einfühlendes Verstehen – 1. Grundhaltung nach Rogers',
      ),
      Term(
        term: 'Kongruenz',
        definition:
            'Echtheit/Authentizität des Therapeuten – 3. Grundhaltung nach Rogers',
      ),
      Term(
        term: 'Aktualisierungstendenz',
        definition:
            'Angeborene Tendenz zur Selbstentfaltung und Weiterentwicklung (Rogers)',
      ),
    ],
  ),
  Flashcard(
    ...
    terms: [
      Term(
        term: 'Zirkuläres Fragen',
        definition:
            'Systemische Technik: Ein Familienmitglied über Beziehungen anderer befragen',
      ),
      Term(
        term: 'Parentifizierung',
        definition: 'Pathologische Rollenumkehr: Kind übernimmt Elternfunktion',
      ),
    ],
  ),
  Flashcard(
    ...
    terms: [
      Term(
        term: 'EMDR',
        definition:
            'Traumatherapie durch bilaterale Stimulation (Augenbewegungen) – evidenzbasiert',
      ),
    ],
  ),
  Flashcard(
    ...
    terms: [
      Term(
        term: 'DBT',
        definition:
            'Dialektisch-Behaviorale Therapie – speziell für Borderline entwickelt (Linehan)',
      ),
      Term(
        term: 'CBASP',
        definition:
            'Cognitive Behavioral Analysis System of Psychotherapy – für chronische Depression',
      ),
    ],
  ),
  Flashcard(
    ...
    terms: [
      Term(
        term: 'Extrapyramidale NW',
        definition:
            'Bewegungsstörungen durch Neuroleptika: Dyskinesien, Akathisie, Parkinsonoid',
      ),
      Term(
        term: 'Akathisie',
        definition:
            'Quälende Sitz-/Bewegungsunruhe – Nebenwirkung von Neuroleptika',
      ),
      Term(
        term: 'Dyskinesien',
        definition:
            'Unwillkürliche Bewegungen – häufige Neuroleptika-Nebenwirkung',
      ),
    ],
  ),
  Flashcard(
    ...
    terms: [
      Term(
        term: 'Serotoninsyndrom',
        definition:
            'Lebensbedrohliche Serotonin-Überaktivierung – Unruhe, Muskelzuckungen, Fieber, Tremor',
      ),
    ],
  ),
  Flashcard(
    ...
    terms: [
      Term(
        term: 'Phytopharmakon',
        definition: 'Arzneimittel auf pflanzlicher Basis',
      ),
      Term(
        term: 'CYP-Enzym-Induktion',
        definition:
            'Beschleunigter Abbau anderer Medikamente in der Leber – deren Wirkung sinkt',
      ),
    ],
  ),
  Flashcard(
    ...
    terms: [
      Term(
        term: 'Negative Verstärkung',
        definition: 'Verhalten nimmt zu, weil unangenehmer Reiz entfernt wird',
      ),
      Term(
        term: 'Indirekte Bestrafung (Typ II)',
        definition: 'Angenehmer Reiz wird entzogen → Verhalten nimmt ab',
      ),
    ],
  ),
  Flashcard(
    ...
    terms: [
      Term(
        term: 'Klassische Konditionierung',
        definition:
            'Lernen durch Reizkopplung (Pawlow) – neutraler Reiz wird zum konditionierten Reiz',
      ),
      Term(
        term: 'Operante Konditionierung',
        definition:
            'Lernen durch Konsequenzen (Skinner) – Verstärkung und Bestrafung steuern das Verhalten',
      ),
    ],
  ),
  Flashcard(
    ...
    terms: [
      Term(
        term: 'Löschung (Extinktion)',
        definition:
            'Abbau eines konditionierten Verhaltens bei ausbleibender Verstärkung',
      ),
      Term(
        term: 'Löschungsresistenz',
        definition:
            'Widerstandsfähigkeit gegen Löschung – am höchsten bei intermittierender Verstärkung',
      ),
    ],
  ),
  Flashcard(
    ...
    terms: [
      Term(
        term: 'Shaping',
        definition:
            'Verhaltensformung durch Verstärkung schrittweiser Annäherungen',
      ),
      Term(
        term: 'Chaining',
        definition:
            'Verkettung beherrschter Teilschritte zu einer Verhaltenskette',
      ),
      Term(
        term: 'Premack-Prinzip',
        definition:
            'Häufig gezeigtes Verhalten dient als Verstärker für selten gezeigtes',
      ),
    ],
  ),
  Flashcard(
    ...
    terms: [
      Term(
        term: 'Modelllernen',
        definition:
            'Lernen am Modell durch Beobachtung und Nachahmung (Bandura)',
      ),
      Term(
        term: 'Stellvertretende Verstärkung',
        definition:
            'Die beobachtete Belohnung eines Modells verstärkt das eigene Verhalten',
      ),
    ],
  ),
  Flashcard(
    ...
    terms: [
      Term(
        term: 'Reizgeneralisierung',
        definition:
            'Übertragung der konditionierten Reaktion auf ähnliche Reize',
      ),
      Term(
        term: 'Sensitivierung',
        definition:
            'Zunahme der Reaktion auf einen wiederholten Reiz – Gegenteil der Habituation',
      ),
    ],
  ),
  Flashcard(
    ...
    terms: [
      Term(
        term: 'SORKC-Modell',
        definition:
            'Verhaltensanalyse: Stimulus-Organismus-Reaktion-Kontingenz-Consequenz',
      ),
      Term(
        term: 'Katathymes Bilderleben',
        definition: 'Tiefenpsychologisches Verfahren mit gelenkter Imagination',
      ),
    ],
  ),
  Flashcard(
    ...
    terms: [
      Term(
        term: 'Resilienz',
        definition:
            'Psychische Widerstandsfähigkeit trotz belastender Umstände',
      ),
      Term(
        term: 'Compliance',
        definition:
            'Therapietreue – Ausmaß, in dem Patient Behandlungsempfehlungen befolgt',
      ),
      Term(
        term: 'Erlernte Hilflosigkeit',
        definition:
            'Lerntheoretisches Depressionsmodell (Seligman) – Überzeugung, nichts ändern zu können',
      ),
    ],
  ),
  Flashcard(
    ...
    terms: [
      Term(
        term: 'SSRI',
        definition:
            'Selektive Serotonin-Wiederaufnahmehemmer – Antidepressiva 1. Wahl',
      ),
      Term(
        term: 'Serotonin',
        definition:
            'Neurotransmitter für Stimmung, Schlaf, Schmerz – ca. 90% im Darm',
      ),
    ],
  ),
  Flashcard(
    ...
    terms: [
      Term(
        term: 'BDI-II',
        definition:
            'Beck-Depressions-Inventar – Selbstbeurteilungsfragebogen für Depressivität',
      ),
    ],
  ),
  ...
  Flashcard(
    ...
    terms: [
      Term(
        term: 'Hippocampus',
        definition:
            'Hirnstruktur für Gedächtnisbildung und Überführung ins Langzeitgedächtnis',
      ),
      Term(
        term: 'Limbisches System',
        definition:
            'Hirnregion für Emotionsverarbeitung, Motivation und Gedächtnis',
      ),
    ],
  ),
  Flashcard(
  ...
  Flashcard(
    ...
    terms: [
      Term(
        term: 'PsychKG',
        definition:
            'Psychisch-Kranken-Gesetz – öffentlich-rechtliche Unterbringung bei Fremd-/Selbstgefährdung',
      ),
      Term(
        term: 'Maßregelvollzug (§63 StGB)',
        definition:
            'Unterbringung in psychiatrischem Krankenhaus nach Straftat bei Schuldunfähigkeit',
      ),
    ],
  ),
  Flashcard(
  ...
  Flashcard(
    ...
    terms: [
      Term(
        ...
        definition:
            'Vorausverfügung über med. Behandlung – schließt Unterbringung nicht grundsätzlich aus',
      ),
    ],
  ),
  Flashcard(
  ...
  Flashcard(
    ...
    terms: [
      Term(
        term: 'Fremdgefährdung',
        definition:
            'Gefahr, die ein psychisch Kranker für andere Personen darstellt – kann Unterbringung rechtfertigen',
      ),
    ],
  ),
  Flashcard(
    ...
    terms: [
      Term(
        term: 'Rechtliche Betreuung',
        definition:
            'Gesetzliche Vertretung für Volljährige, die ihre Angelegenheiten nicht selbst besorgen können',
      ),
    ],
  ),
  Flashcard(
  ...
  Flashcard(
    ...
    terms: [
      Term(
        term: 'Betreuungsrecht (§§1814 ff. BGB)',
        definition:
            'Rechtlicher Betreuer für einzelne Aufgabenkreise bei krankheitsbedingter Hilfsbedürftigkeit',
      ),
    ],
  ),
  Flashcard(
    ...
    terms: [
      Term(
        term: 'Einwilligungsvorbehalt',
        definition:
            'Bestimmte Rechtsgeschäfte des Betreuten nur mit Zustimmung des Betreuers wirksam',
      ),
    ],
  ),
  Flashcard(
  ...
  Flashcard(
    ...
    terms: [
      Term(
        term: 'Approbation',
        definition:
            'Staatliche Zulassung zur Berufsausübung als Arzt oder Psychotherapeut',
      ),
    ],
  ),
  Flashcard(
  ...
  Flashcard(
    ...
    terms: [
      Term(
        term: 'IfSG',
        definition:
            'Infektionsschutzgesetz – regelt Meldepflicht bei Infektionskrankheiten',
      ),
      Term(
        term: 'BtMG',
        definition:
            'Betäubungsmittelgesetz – regelt Umgang mit Betäubungsmitteln (z.B. Fentanyl, Methadon)',
      ),
    ],
  ),
  Flashcard(
    ...
    terms: [
      Term(
        term: 'Dokumentationspflicht',
        definition:
            'Pflicht zur Dokumentation der Behandlung – Aufbewahrung 10 Jahre (§630f BGB)',
      ),
    ],
  ),
  Flashcard(
  ...
  Flashcard(
    ...
    terms: [
      Term(
        term: 'Schweigepflicht',
        definition:
            'Pflicht zur Verschwiegenheit über Patientendaten – Durchbrechung nur in Ausnahmefällen',
      ),
    ],
  ),
  Flashcard(
  ...
  Flashcard(
    ...
    terms: [
      Term(
        term: 'GebüH',
        definition:
            'Gebührenverzeichnis für Heilpraktiker – Orientierungshilfe, nicht verbindlich',
      ),
      Term(
        term: 'Aufklärungspflicht (§630e BGB)',
        definition:
            'Mündliche Aufklärung vor Behandlung über Diagnose, Therapie, Risiken, Alternativen',
      ),
    ],
  ),
  Flashcard(
    ...
    terms: [
      Term(
        term: 'Antisuizidvertrag',
        definition:
            'Therapeutische Vereinbarung: Patient verpflichtet sich, vor Suizidhandlung Hilfe zu suchen',
      ),
    ],
  ),
  Flashcard(
  ...
  Flashcard(
    ...
    terms: [
      Term(
        term: 'Behandlungsvertrag (§630a BGB)',
        definition:
            'Dienstvertrag – HPP schuldet sorgfältige Behandlung, nicht den Behandlungserfolg',
      ),
    ],
  ),
  Flashcard(
  ...
  Flashcard(
    ...
    terms: [
      Term(
        term: 'Kognitive Umstrukturierung',
        definition: 'Identifikation und Veränderung dysfunktionaler Denkmuster',
      ),
    ],
  ),
  Flashcard(
    ...
    terms: [
      Term(
        term: 'INEP',
        definition:
            'Inventar zur Erfassung negativer Effekte von Psychotherapie',
      ),
    ],
  ),
  Flashcard(
  ...
  Flashcard(
    ...
    terms: [
      Term(
        term: 'Hyperarousal',
        definition:
            'erhöhtes Erregungsniveau mit Schreckhaftigkeit und Überwachsamkeit',
      ),
      Term(
        term: 'Flashbacks',
        definition:
  ...
  Flashcard(
    ...
    terms: [
      Term(
        term: 'Neurasthenie (F48)',
        definition:
            'Erschöpfungssyndrom mit anhaltender Müdigkeit nach geringer Anstrengung',
      ),
    ],
  ),
  Flashcard(
  ...
  Flashcard(
    ...
    terms: [
      Term(
        ...
        definition:
            'Aufklärung des Patienten über seine Erkrankung und Behandlung',
      ),
      Term(
        term: 'Systematische Desensibilisierung',
        definition:
  ...
  Flashcard(
    ...
    terms: [
      Term(
        term: 'Stimuluskontrolle',
        definition:
            'Schlaftherapie-Technik: Bett nur zum Schlafen nutzen, bei Schlaflosigkeit aufstehen',
      ),
    ],
  ),
  Flashcard(
    ...
    terms: [
      Term(
        term: 'Körperschemastörung',
        definition:
            'verzerrte Wahrnehmung des eigenen Körpers (z.B. sich dick fühlen trotz Untergewicht)',
      ),
    ],
  ),
  Flashcard(
  ...
  Flashcard(
    ...
    terms: [
      ...
      Term(
        term: 'Ich-synton',
        definition:
            'als zur eigenen Person gehörend erlebt, nicht als störend empfunden',
      ),
    ],
  ),
  Flashcard(
    ...
    terms: [
      Term(
        term: 'Benzodiazepine',
        definition:
            'Beruhigungsmittel mit angstlösender, sedierender Wirkung (hohes Abhängigkeitspotenzial)',
      ),
    ],
  ),
  Flashcard(
    ...
    terms: [
      Term(
        term: 'Exposition',
        definition:
            'therapeutische Konfrontation mit angstauslösenden Reizen zur Habituation',
      ),
    ],
  ),
  Flashcard(
    ...
    terms: [
      Term(
        term: 'Denkhemmung',
        definition:
            'Verlangsamtes Denken – typisch bei Depression (Gegenteil von Ideenflucht)',
      ),
    ],
  ),
  Flashcard(
  ...
  Flashcard(
    ...
    terms: [
      Term(
        term: 'Zeitkriterien',
        definition:
            'Mindestdauern zur Diagnosestellung – häufig in der Prüfung abgefragt',
      ),
    ],
  ),
  Flashcard(
  ...
  Flashcard(
    ...
    terms: [
      Term(
        term: 'Malignes Neuroleptisches Syndrom',
        definition:
            'Lebensbedrohliche NW von Neuroleptika: Fieber, Rigor, Bewusstseinsstörung, CK↑',
      ),
    ],
  ),
  Flashcard(
    ...
    terms: [
      ...
      Term(
        term: 'Schweigepflicht',
        definition:
            'gesetzliche Pflicht zur Geheimhaltung anvertrauter Informationen (§203 StGB)',
      ),
    ],
  ),
  ...
  Flashcard(
    ...
    terms: [
      Term(
        term: 'Schuldunfähigkeit (§20 StGB)',
        definition:
            'Aufgehobene Einsichts-/Steuerungsfähigkeit bei psychischer Störung zum Tatzeitpunkt',
      ),
      Term(
        term: 'Verminderte Schuldfähigkeit (§21 StGB)',
        definition:
            'Erheblich eingeschränkte Steuerungsfähigkeit – Strafmilderung möglich',
      ),
    ],
  ),
  Flashcard(
    ...
    terms: [
      Term(
        term: 'Bewusstseinsstörung',
        definition: 'Beeinträchtigung der Wachheit oder des Erlebens',
      ),
      Term(
        term: 'Paraphilien (F65)',
        definition:
  ...
  Flashcard(
    ...
    terms: [
      Term(
        ...
        definition:
            'Besondere Schutzpflicht des Therapeuten gegenüber dem Patienten durch Übernahme der Behandlung',
      ),
    ],
  ),
  Flashcard(
    ...
    terms: [
      Term(
        term: 'Unterlassene Hilfeleistung (§323c StGB)',
        definition:
            'Strafbare Nichtleistung von Hilfe bei Unglücksfällen oder gemeiner Gefahr',
      ),
    ],
  ),
  Flashcard(
    ...
    terms: [
      Term(
        term: 'Einwilligungsfähigkeit',
        definition:
            'Fähigkeit, Art und Tragweite einer Behandlung zu verstehen – kein festes Mindestalter',
      ),
    ],
  ),
  Flashcard(
  ...
  Flashcard(
    ...
    terms: [
      Term(
        term: 'Beweislastumkehr (§630h BGB)',
        definition:
            'Bei Dokumentationsmängeln muss der HPP beweisen, dass kein Fehler vorlag',
      ),
    ],
  ),
  Flashcard(
    ...
    terms: [
      Term(
        term: 'DSGVO Art. 9',
        definition:
            'Besonderer Schutz sensibler Daten (Gesundheitsdaten) – strenge Verarbeitungsregeln',
      ),
      Term(
        term: '§203 StGB',
        definition:
            'Verletzung von Privatgeheimnissen – Strafbarkeit bei Bruch der Schweigepflicht',
      ),
    ],
  ),
  Flashcard(
    ...
    terms: [
      Term(
        term: 'Meldepflicht',
        definition:
            'gesetzliche Pflicht zur Meldung bestimmter Erkrankungen (z.B. nach IfSG)',
      ),
    ],
  ),
  Flashcard(
    ...
    terms: [
      Term(
        term: 'HWG',
        definition:
            'Heilmittelwerbegesetz – verbietet Heilversprechen und irreführende Werbung',
      ),
    ],
  ),
  Flashcard(
    ...
    terms: [
      Term(
        term: 'Abstinenzregel',
        definition:
            'Verbot privater/sexueller Beziehungen zum Patienten – auch nach Therapieende',
      ),
    ],
  ),
  Flashcard(
  ...
  Flashcard(
    ...
    terms: [
      Term(
        term: 'Freier Beruf',
        definition:
            'HPP-Tätigkeit ist kein Gewerbe – keine Gewerbeanmeldung, aber Finanzamt-Anmeldung nötig',
      ),
      Term(
        term: '§4 Nr. 14 UStG',
        definition: 'Umsatzsteuerbefreiung für Heilbehandlungen durch HPP',
      ),
    ],
  ),
  Flashcard(
    ...
    terms: [
      Term(
        term: 'Sektoraler HPP',
        definition:
            'Heilpraktiker beschränkt auf Psychotherapie – darf keine körperlichen Verfahren anwenden',
      ),
    ],
  ),
  Flashcard(
  ...
  Flashcard(
    ...
    terms: [
      Term(
        term: '§8a SGB VIII',
        definition:
            'Schutzauftrag bei Kindeswohlgefährdung – Verpflichtung zur Einschaltung des Jugendamts',
      ),
    ],
  ),
  Flashcard(
    ...
    terms: [
      Term(
        term: 'Vorsorgevollmacht',
        definition:
            'Private Bevollmächtigung einer Vertrauensperson für den Fall der Entscheidungsunfähigkeit',
      ),
      Term(
        term: 'Betreuungsverfügung',
        definition:
            'Festlegung, wer als gesetzlicher Betreuer bestellt werden soll',
      ),
    ],
  ),
  Flashcard(
  ...
  Flashcard(
    ...
    terms: [
      Term(
        term: 'Erforderlichkeitsgrundsatz',
        definition:
            'Betreuung nur wenn nötig und keine mildere Maßnahme verfügbar (§1814 BGB)',
      ),
    ],
  ),
  ...
  Flashcard(
    ...
    terms: [
      Term(
        term: 'Vulnerabilität',
        definition:
            'Individuelle Verwundbarkeit gegenüber psychischer Erkrankung',
      ),
      Term(
        term: 'Multifaktorielle Genese',
        definition:
            'Entstehung durch Zusammenwirken biologischer, psychischer und sozialer Faktoren',
      ),
    ],
  ),
  Flashcard(
    ...
    terms: [
      Term(
        term: 'AMDP-System',
        definition:
            'Standard zur methodischen Dokumentation psychiatrischer Befunde',
      ),
      Term(
        term: 'Auffassungsstörung',
        definition:
            'Gestörtes Erfassen der Bedeutung von Äußerungen und Texten',
      ),
    ],
  ),
  Flashcard(
    ...
    terms: [
      Term(
        term: 'Synthymer Wahn',
        definition: 'Wahninhalt passt zur Stimmungslage (stimmungskongruent)',
      ),
      Term(
        term: 'Versündigungswahn',
        definition: 'Wahnhafte Schuldüberzeugung bei schwerer Depression',
      ),
      Term(
        term: 'Dermatozoenwahn',
        definition:
            'Wahn eines Insektenbefalls der Haut – organisch oder bei Kokain',
      ),
    ],
  ),
  Flashcard(
    ...
    terms: [
      Term(
        term: 'Gedankenabriss',
        definition:
            'Plötzliches Abreißen des Gedankengangs ohne Fremdeinwirkung – formal',
      ),
      Term(
        term: 'Gedankenentzug',
        definition:
            'Erleben, dass Gedanken von außen weggenommen werden – Ich-Störung',
      ),
      Term(
        term: 'Logorrhoe',
        definition: 'Rededrang mit vermehrtem, kaum unterbrechbarem Sprechen',
      ),
    ],
  ),
  Flashcard(
    ...
    terms: [
      Term(
        term: 'Akathisie',
        definition: 'Sitzunruhe mit quälendem Bewegungsdrang',
      ),
      Term(term: 'Adynamie', definition: 'Antriebs- und Kraftlosigkeit'),
      Term(
        term: 'Bradyphrenie',
        definition: 'Verlangsamung des Denkens – typisch bei Morbus Parkinson',
      ),
      Term(
        term: 'Manierismen',
        definition: 'Sonderbar verschrobene, gekünstelte Bewegungen',
      ),
    ],
  ),
  Flashcard(
    ...
    terms: [
      Term(
        term: 'Dopaminhypothese',
        definition:
            'Positivsymptomatik durch dopaminerge Überaktivität im mesolimbischen System',
      ),
      Term(
        term: 'Parkinsonoid',
        definition: 'Medikamentös induziertes, reversibles Parkinson-Syndrom',
      ),
      Term(
        term: 'Biperiden',
        definition: 'Anticholinergikum gegen neuroleptika-induzierte EPMS',
      ),
    ],
  ),
  Flashcard(
    ...
    terms: [
      Term(
        term: 'Larvierte Depression',
        definition:
            'Depression, deren Kernsymptomatik hinter körperlichen Beschwerden verborgen ist',
      ),
    ],
  ),
  Flashcard(
    ...
    terms: [
      Term(
        term: 'Rapid Cycling',
        definition: 'Mindestens 4 affektive Episoden pro Jahr',
      ),
      Term(
        term: 'Phasenprophylaxe',
        definition: 'Langzeitmedikation zur Verhinderung erneuter Episoden',
      ),
    ],
  ),
  Flashcard(
    ...
    terms: [
      Term(
        term: 'Pathologisches Horten',
        definition:
            'Zwanghaftes Anhäufen wertloser Gegenstände in der eigenen Wohnung',
      ),
    ],
  ),
  Flashcard(
    ...
    terms: [
      Term(
        term: 'Präsuizidales Syndrom',
        definition:
            'Einengung, gehemmte Aggression, Suizidfantasien (nach Ringel)',
      ),
      Term(
        term: 'Verhältnisprävention',
        definition: 'Prävention durch Veränderung der äußeren Umstände',
      ),
    ],
  ),
  Flashcard(
    ...
    terms: [
      Term(
        term: 'Projektion',
        definition: 'Zuschreibung eigener abgelehnter Impulse an andere',
      ),
      Term(
        term: 'Regression',
        definition: 'Rückfall auf frühere Entwicklungsstufen',
      ),
      Term(
        term: 'Identifikation',
        definition: 'Übernahme von Eigenschaften einer anderen Person',
      ),
    ],
  ),
  Flashcard(
    ...
    terms: [
      Term(
        term: 'Kognitive Triade',
        definition: 'Negative Sicht auf Selbst, Welt und Zukunft (Beck)',
      ),
      Term(
        term: 'RET',
        definition: 'Rational-emotive Therapie nach Ellis mit ABC-Modell',
      ),
    ],
  ),
  Flashcard(
    ...
    terms: [
      Term(
        term: 'Entgiftung',
        definition: 'Körperlicher Entzug unter medizinischer Überwachung',
      ),
      Term(
        term: 'Entwöhnung',
        definition: 'Psychotherapeutische Phase zur Sicherung der Abstinenz',
      ),
    ],
  ),
];
